...
mar_cell_MKII::mar_cell_MKII()
{
	...
	GATES_INDICES = new unsigned short[gates_size]{34,13,18,37,14,22,36,38,10,26,15,40,16,1,0,11,35,19,25,33,21,24,2,32,9,20,6,12,5,8,30,31,3,};
	snprintf(GATES_HEADER, sizeof(GATES_HEADER), "m,j,jp,hf,hs,hsp,mL,hL,hLp,a,ap,ki,iF,iS,iFp,iSp,xrf,xrs,xs1,xs2,xk1,d,ff,fs,fcaf,nca,jca,fcas,ffp,fcafp,Jrelnp,Jrelp,CaMKt,");
}
...
mar_cell_MKII::~mar_cell_MKII()
{
	...
	delete STATES;
	delete RATES;
	delete GATES_INDICES;
}

void mar_cell_MKII::___initConsts()
{
...
void mar_cell_MKII::___applyDrugEffect(double conc, double *ic50, double epsilon)
{
...
void mar_cell_MKII::initConsts()
{
	CONSTANTS[0] = 0;
	___initConsts();
}

void mar_cell_MKII::initConsts(double celltype)
{
	CONSTANTS[0] = celltype;
	___initConsts();
}

void mar_cell_MKII::initConsts(double celltype, double conc, double *ic50)
{
	CONSTANTS[0] = celltype;
	___initConsts();
...
void mar_cell_MKII::computeRates(double TIME, double* CONSTANTS, double* RATES, double* STATES, double* ALGEBRAIC)
{
...
void mar_cell_MKII::solveAnalytical(double dt)
{
  ////==============
  ////Exact solution
  ////==============
